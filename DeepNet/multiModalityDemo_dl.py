...
def parseOptions(argv):
    ...
    parser.add_option("--trainViewBasedFeature",
                      action="store",
                      dest="trainViewBasedFeature",
#                      default='testData/feature.npy',
                      help="trainning view Feature file name")
    parser.add_option("--testViewBasedFeature",
                      action="store",
                      dest="testViewBasedFeature",
#                      default='testData/feature.npy',
                      help="testing view Feature file name")
    parser.add_option("--trainShapeBasedFeature",
                      action="store",
                      dest="trainShapeBasedFeature",
#                      default='testData/feature.npy',
                      help="trainning shape Feature file name")
    parser.add_option("--testShapeBasedFeature",
                      action="store",
                      dest="testShapeBasedFeature",
#                      default='testData/feature.npy',
                      help="testing shape Feature file name")
    parser.add_option("--trainLabel",
                      action="store",
                      dest="trainLabel",
#                      default='testData/label.npy',
                      help="trainning Label file name")
    parser.add_option("--testLabel",
                      action="store",
                      dest="testLabel",
#                      default='testData/label.npy',
                      help="testing Label file name")
    parser.add_option("-m", "--model",
                      action="store",
                      dest="model",
                      default='testData/multiModalityModel.npy',
